...
const MESSAGES = {
  ja: {
    ...
    'draw.clear': 'キャンバスを消す',
        ...
        'draw.record': '変形をGIFで保存',
        'draw.recordFailed': '動画を保存できませんでした。もう一度試してください',
...
'gallery.reportDone': '通報を受け付けました。ありがとうございます',
  ...
  en: {
    ...
    'draw.clear': 'Clear canvas',
        ...
        'draw.record': 'Save the morph as a GIF',
        'draw.recordFailed': 'Could not save the video. Please try again',
...
'gallery.reportDone': 'Reported. Thank you',
  ...
  zh: {
    ...
    'draw.clear': '清除画布',
        ...
        'draw.record': '把变形过程保存为 GIF',
        'draw.recordFailed': '视频保存失败，请重试',
